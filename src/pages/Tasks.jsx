        ...
        <div className="mb-8 flex items-end justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="mt-2 text-slate-400 max-w-2xl text-sm md:text-base">
              Track <span className="text-slate-200 font-semibold">completed</span>,{" "}
              <span className="text-slate-200 font-semibold">deadlines</span> and{" "}
              <span className="text-slate-200 font-semibold">priority</span> like a Premium dashboard.
            </p>
          </div>
